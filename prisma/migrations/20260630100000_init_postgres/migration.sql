...
-- AddForeignKey
ALTER TABLE "room_bookings" ADD CONSTRAINT "room_bookings_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
INSERT INTO "system_settings" ("key", "value") VALUES ('rooms_enabled', 'true') ON CONFLICT DO NOTHING;
