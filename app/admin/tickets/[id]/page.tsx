...
import { statusLabel, typeLabel, priorityLabel, formatDate, permissionActionLabel } from "@/lib/utils";
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="rounded-2xl p-6" style={{ background: "#FFFFFF", border: "1px solid #DCEAD9" }}>
        ...
        {ticket.type === "DEVELOPMENT" && (ticket.approvalChainChange || ticket.affectedScreen) && (
