  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {[
            ...
            <div key={t.value} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <p className="text-sm text-gray-500 mb-4">إعدادات Nodemailer لإشعارات تغيير الحالة</p>
