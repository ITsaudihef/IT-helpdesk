    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="rounded-2xl p-5 flex flex-col justify-between"
          ...
          <div className="mt-4 pt-3 border-t border-purple-100 flex items-center justify-between">
            ...
            <span className="text-lg font-bold" style={{ color: "#16241D" }}>{total}</span>
          </div>
        </div>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-bold" style={{ color: "#16241D" }}>آخر التذاكر</h2>
          <Link href="/portal/tickets" className="text-sm font-medium hover:underline" style={{ color: "#007F5C" }}>
            عرض الكل
          </Link>
        </div>
        ...
        {tickets.length === 0 ? (
          <div className="rounded-2xl p-12 text-center shadow-sm" style={{ background: "#FFFFFF", border: "1px solid #DCEAD9" }}>
            ...
            <h3 className="font-semibold mb-1" style={{ color: "#16241D" }}>لا توجد تذاكر بعد</h3>
