  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl p-6 text-white relative overflow-hidden"
        style={{ background: "linear-gradient(135deg, #6fb54a 0%, #00805b 100%)" }}>
        ...
        <div className="relative">
          ...
          <p className="text-green-100 text-sm">يمكنك رفع طلبات دعم IT وتتبع حالتها من هنا</p>
          <Link href="/portal/new"
            className="inline-flex items-center gap-2 mt-4 bg-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors hover:bg-green-50"
            style={{ color: "#00805b" }}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          { label: "مفتوحة",         value: open,       icon: AlertCircle,  bg: "#e0f1d0",  fg: "#00805b" },
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-bold text-gray-900">آخر التذاكر</h2>
          <Link href="/portal/tickets" className="text-sm font-medium hover:underline" style={{ color: "#6fb54a" }}>
            عرض الكل
          </Link>
        </div>
        ...
        {tickets.length === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center shadow-sm">
            <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style={{ background: "#e0f1d0" }}>
              <Ticket className="w-8 h-8" style={{ color: "#6fb54a" }} />
            </div>
            <h3 className="font-semibold text-gray-900 mb-1">لا توجد تذاكر بعد</h3>
            <p className="text-sm text-gray-500 mb-4">ارفع أول تذكرة دعم لك</p>
            <Link href="/portal/new"
