  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-semibold" style={{ color: "#16241D" }}>تذاكري ({total})</h1>
      ...
      {waitingCount > 0 && !status && (
        <div className="rounded-xl p-3 flex items-center justify-between"
          style={{ background: "rgba(0,127,92,0.08)", border: "1px solid #A8DB98" }}>
          <p className="text-sm font-semibold" style={{ color: "#00543D" }}>
      ...
      {total === 0 ? (
        <div className="rounded-2xl p-12 text-center" style={{ background: "#FFFFFF", border: "1px solid #DCEAD9" }}>
          <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style={{ background: "rgba(0,127,92,0.15)" }}>
            <Ticket className="w-8 h-8" style={{ color: "#007F5C" }} />
          </div>
          <h3 className="font-medium mb-1" style={{ color: "#16241D" }}>لا توجد تذاكر</h3>
