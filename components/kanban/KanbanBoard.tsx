...
function formatDate(iso?: string | null) {
  if (!iso) return "";
  return new Date(iso).toLocaleDateString("ar-SA-u-nu-latn", { day: "numeric", month: "short", year: "numeric", calendar: "gregory" });
}
                      ...
                      <div className="flex items-center gap-1.5 flex-wrap">
                        ...
                        {card.dueDate && (
                          <span
                            ...
                            {new Date(card.dueDate).toLocaleDateString("ar-SA-u-nu-latn", { day: "numeric", month: "short", calendar: "gregory" })}
                          </span>
                        )}
                      </div>
                    </div>
