...
const FILTERS = [
  { name: "status",   label: "الحالة",   opts: ["OPEN","IN_PROGRESS","PENDING_USER_TEST","READY_TO_LAUNCH","LAUNCHED","PENDING_DEPT_APPROVAL","PENDING_APPROVAL","WAITING_INFO","RESOLVED","CLOSED"] },
